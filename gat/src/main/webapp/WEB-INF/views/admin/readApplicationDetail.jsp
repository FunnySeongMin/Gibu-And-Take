...
<div class="page-heading bg-sub-3-gnt">
	<h4 class="py-5 text-center">신청서 보기</h4>
</div>
	...
	<div class="row">
		<div class="col-10 offset-lg-1">
			<div class="d-flex align-items-end">
				<a href="${pageContext.request.contextPath }/readApplicationList.do?nowPage=1" class="btn btn-sub-2-gnt ml-auto mr-1 " id="#" >목록</a>
				<c:choose>
