				...
				<div class="control-group form-group">
					<div class="controls">
						<label>재능기부 프로젝트명</label> <input type="text" class="form-control"
							id="appTitle" name="appTitle" value="${apVO.appTitle }" required
				...
				<div class="control-group form-group">
					<div class="controls">
						<label>재능기부 기간</label> <input type="date" id="start_date"
							name="startDate" value="${apVO.startDate }"> - <input type="date" id="end_date"
							name="endDate" value="${apVO.endDate }">
					</div>
				</div>
				<div class="control-group form-group">
					<div class="controls">
						...
						<input class="form-control" style="top: 5px;" placeholder="주소"
							name="place" id="place" type="text" value="${apVO.place }"/>
					</div>
				...
				<div class="control-group form-group">
					<div class="controls">
						<label>목표 마일리지</label> <input type="number" class="form-control"
							name="goalMileage" required="required" value="${apVO.goalMileage }">
					</div>
				</div>
				<div class="control-group form-group">
					<div class="controls">
						<label>선물 목록1</label> <input type="number" class="form-control"
							...
							required="required" value=${apVO.presentList[0].donationMileage } ><input type="text"
							class="form-control" name="presentContents1"
							placeholder="선물내용을 입력하세요" required="required" value="${apVO.presentList[0].presentContents } ">
					</div>
					<div class="controls">
						<label>선물 목록2</label> <input type="number" class="form-control"
							name="donationMileage2" placeholder="선물 마일리지를 입력하세요"
							value=${apVO.presentList[1].donationMileage }> <input
							type="text" class="form-control" name="presentContents2"
							placeholder="선물내용을 입력하세요" value="${apVO.presentList[1].presentContents }">
					</div>
					<div class="controls">
						<label>선물 목록3</label> <input type="number" class="form-control"
							name="donationMileage3" placeholder="선물 마일리지를 입력하세요"
							value=${apVO.presentList[2].donationMileage }> <input
							type="text" class="form-control" name="presentContents3"
							placeholder="선물내용을 입력하세요" value="${apVO.presentList[2].presentContents }">
					</div>
				</div>
				<div class="control-group form-group">
					<label>대표 이미지</label>
					...
					<input type="file" class="form-control" name="main_image"
						required="required" value="${apVO.imgDirectory }">
				</div>
				<div class="control-group form-group">
					<div class="controls">
						<label>재능기부 프로젝트 요약</label> <input type="text" class="form-control"
							name="appSummery" placeholder="선물내용을 입력하세요" value="${apVO.appSummery }" >
					</div>
				</div>
				<div class="control-group form-group">
					<div class="controls">
						...
						<textarea name="appContents" id="appContents" rows="10" cols="100"
							...
							style="width: 918px; height: 412px;" >${apVO.appContents }</textarea>
					</div>
				</div>
				<div id="success"></div>
