    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	sUploadURL= '/gat/multiplePhotoUpload.do';     //다중파일업로드 URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/gat/photoUpload.do', //파일업로드시 동작되는 컨트롤러 url
 			sCallback : '/gat/resources/editor/photo_uploader/popup/callback.html',  //업로드 이후  redirect 페이지 url
