...
public class DonationPostPagingBean {
	//현재 페이지
	...
	public DonationPostPagingBean() {
		super();
	}
	public DonationPostPagingBean(int totalPostCount) {
		super();
		this.totalPostCount = totalPostCount;
	}
	public DonationPostPagingBean(int totalPostCount, int nowPage) {
		super();
		this.totalPostCount = totalPostCount;
	...
	public static void main(String args[]) {
		 DonationPostPagingBean p = new DonationPostPagingBean(470, 10);
		 ...
		 System.out.println("////////////////////////////");
		 p = new DonationPostPagingBean(710, 14);// 게시물수 31 현재 페이지 6
