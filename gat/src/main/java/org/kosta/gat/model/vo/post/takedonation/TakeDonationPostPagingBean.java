...
public class TakeDonationPostPagingBean {
	//현재 페이지
	...
	public TakeDonationPostPagingBean() {
		super();
	}
	public TakeDonationPostPagingBean(int totalPostCount) {
		super();
		this.totalPostCount = totalPostCount;
	}
	public TakeDonationPostPagingBean(int totalPostCount, int nowPage) {
		super();
		this.totalPostCount = totalPostCount;
	...
	public static void main(String args[]) {
		 TakeDonationPostPagingBean p = new TakeDonationPostPagingBean(470, 10);
		 ...
		 System.out.println("////////////////////////////");
		 p = new TakeDonationPostPagingBean(710, 14);// 게시물수 31 현재 페이지 6
