...
public class MemberPagingBean {
	...
	public MemberPagingBean(int totalPostCount) {
		super();
		this.totalPostCount = totalPostCount;
	}
	public MemberPagingBean(int totalPostCount, int nowPage) {
		super();
		this.totalPostCount = totalPostCount;
	...
	public static void main(String args[]) {
		 MemberPagingBean p = new MemberPagingBean(470, 10);
		 ...
		 System.out.println("////////////////////////////");
		 p = new MemberPagingBean(710, 14);// 게시물수 31 현재 페이지 6
