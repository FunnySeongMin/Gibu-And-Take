...
public class WebQuestionPostPagingBean {
	//현재 페이지
	...
	public WebQuestionPostPagingBean() {
		super();
	}
	public WebQuestionPostPagingBean(int totalPostCount) {
		super();
		this.totalPostCount = totalPostCount;
	}
	public WebQuestionPostPagingBean(int totalPostCount, int nowPage) {
		super();
		this.totalPostCount = totalPostCount;
	...
	public static void main(String args[]) {
		 WebQuestionPostPagingBean p = new WebQuestionPostPagingBean(470, 10);
		 ...
		 System.out.println("////////////////////////////");
		 p = new WebQuestionPostPagingBean(710, 14);// 게시물수 31 현재 페이지 6
