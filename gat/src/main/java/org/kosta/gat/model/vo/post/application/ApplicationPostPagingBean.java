...
public class ApplicationPostPagingBean {
	//현재 페이지
	...
	public ApplicationPostPagingBean() {
		super();
	}
	public ApplicationPostPagingBean(int totalPostCount) {
		super();
		this.totalPostCount = totalPostCount;
	}
	public ApplicationPostPagingBean(int totalPostCount, int nowPage) {
		super();
		this.totalPostCount = totalPostCount;
	...
	public static void main(String args[]) {
		 ApplicationPostPagingBean p = new ApplicationPostPagingBean(470, 10);
		 ...
		 System.out.println("////////////////////////////");
		 p = new ApplicationPostPagingBean(710, 14);// 게시물수 31 현재 페이지 6
